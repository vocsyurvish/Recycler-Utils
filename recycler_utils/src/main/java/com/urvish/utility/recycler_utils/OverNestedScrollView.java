package com.urvish.utility.recycler_utils;
...
public class OverNestedScrollView extends FrameLayout implements NestedScrollingParent,
        NestedScrollingChild2, ScrollingView {
    static final int ANIMATED_SCROLL_GAP = 250;

    static final float MAX_SCROLL_FACTOR = 0.5f;

    private static final String TAG = "OverNestedScrollView";
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(OverNestedScrollView v, int scrollX, int scrollY,
    ...
    private boolean mInterceptDispatchToParent;
        ...
        switch (actionMasked) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if ((Math.abs(initialVelocity) > mMinimumVelocity)) {
                    Log.d(TAG, "fling begin!");
                    flingWithNestedDispatch(-initialVelocity);
                } else if (mScroller.springBack(getScrollX(), getScrollY(), 0, 0, 0,
                        getScrollRange())) {
                    Log.d(TAG, "springBack begin!");
                    ViewCompat.postInvalidateOnAnimation(this);
                }
                mActivePointerId = INVALID_POINTER;
                endDrag();
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
            ...
            Log.d(TAG, "computeScroll : true, CurrY：" + y + " ; scrollY : " + getScrollY());

            int dy = y - mLastScrollerY;

            // Dispatch up to parent
            if (!mInterceptDispatchToParent) {
            ...
            if (dy != 0) {
                ...
                overScrollByCompat(0, dy, getScrollX(), oldScrollY, 0, range, 0, mOverScrollY, false);
            ...
            Log.d(TAG, "computeScroll : false, scrollY : " + getScrollY());
            ...
            mInterceptDispatchToParent = false;
        }
    }
    ...
    public void fling(int velocityY) {
        if (getChildCount() > 0) {
            ...
            mInterceptDispatchToParent = true;
            mScroller.fling(getScrollX(), getScrollY(), 0, velocityY, 0, 0, 0,
                    getScrollRange(), 0, mOverScrollY);
            mLastScrollerY = getScrollY();
            ViewCompat.postInvalidateOnAnimation(this);
        }
    }
...
//            }
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final OverNestedScrollView nsvHost = (OverNestedScrollView) host;
